...
$this->img = imagecreatefromstring(file_get_contents($imgname));
    }
    }
     ...
     */
    public function thumb($width, $height, $type = Image::IMAGE_THUMB_SCALE,$bc){
        ...
        switch ($type) {
            ...
            case Image::IMAGE_THUMB_FILLED:
                ...
                do{
                    ...
                    // 调整默认颜色
                    $bc_arr = explode(",",$bc);
                    if ($bc_arr[0]>255 || $bc_arr[0]<0)$bc_arr[0]=255;
                    if ($bc_arr[1]>255 || $bc_arr[1]<0)$bc_arr[1]=255;
                    if ($bc_arr[2]>255 || $bc_arr[2]<0)$bc_arr[2]=255;
                    $color = imagecolorallocate($img, $bc_arr[0],$bc_arr[1],$bc_arr[2]);
                    imagefill($img, 0, 0, $color);
